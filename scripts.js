...
function carregarCarrinho() {
    ...
    listaItens.innerHTML = ''; // Limpar a lista de itens
...
function removerItem(id) {
    ...
    localStorage.setItem('carrinho', JSON.stringify(carrinho));
    carregarCarrinho();  // Recarregar os itens
}

document.addEventListener('DOMContentLoaded', () => {
    exibirProdutos();  // Exibe os produtos na página inicial
    carregarCarrinho();  // Carrega os itens do carrinho na página de carrinho
